package com.fav.fav.project1.querydslExample.data;
...
public class QuerydlsExampleResponseDto extends BaseDto {

    private QuerydlsExampleModel testModel;
    private QuerydlsExampleVo testVo;
}

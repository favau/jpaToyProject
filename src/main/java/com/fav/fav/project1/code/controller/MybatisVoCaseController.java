package com.fav.fav.project1.code.controller;
...
import com.fav.fav.project1.code.data.MybatisVoCaseRequestDto;
import com.fav.fav.project1.code.data.MybatisVoCaseResponseDto;
import com.fav.fav.project1.code.service.MybatisVoCaseService;

@Slf4j
@RestController
@RequestMapping("/project1/mybatisVoCase")
@RequiredArgsConstructor
public class MybatisVoCaseController {
    private final String moduleName = "project1/mybatisVoCase";

...
public interface TestMapper {
    ...
    TestEntity requestToEntity(TestRequestDto dto);
    ...
    TestResponseDto entityToResponse(TestEntity entity);

    // 공통 필드 설정 AfterMapping은 매핑이 끝난 후에 실행
    @AfterMapping
    default void setCommonFields(@MappingTarget TestEntity entity, TestRequestDto dto) {
